...
IF(NOT DEFINED FreeRTOS_DIR)
	MESSAGE(WARNING "FreeRTOS_DIR not set assuming \${STM32Cube_DIR}/Middlewares/Third_Party/FreeRTOS")
	SET(FreeRTOS_DIR ${STM32Cube_DIR}/Middlewares/Third_Party/FreeRTOS)
ENDIF()

FIND_PATH(FREERTOS_COMMON_INC_DIR ${FREERTOS_HEADERS}
	PATH_SUFFIXES include
	HINTS ${FreeRTOS_DIR}/Source
...
FIND_PATH(PORTMACRO_INC_DIR ${PORTMACRO_ARM_HEADER}
	...
	HINTS ${FreeRTOS_DIR}/Source/portable/GCC
	CMAKE_FIND_ROOT_PATH_BOTH
)
...
FIND_FILE(HEAP_IMP_SOURCE ${HEAP_IMP_FILE}
	...
	HINTS ${FreeRTOS_DIR}/Source/portable
	CMAKE_FIND_ROOT_PATH_BOTH
)
